    ...
    public static Collection<Object[]> expectedResults()
      {
        return fixed
          (
            // Powershot G9
            ExpectedResults.create("http://www.rawsamples.ch/raws/canon/g9/RAW_CANON_G9.CR2").
                            image(4000, 3000, 3, 8, "e49fb8c682463e5a20b4923d79894ec2").
                            thumbnail(1600, 1200).
                            thumbnail(160, 120).
                            thumbnail(500, 375).
                            issues("JRW-264"),
            ExpectedResults.create("http://www.rawsamples.ch/raws/canon/g9/RAW_CANON_G9.CR2").
                            ...
                            image(4104, 3048, 3, 16, "f639403ca302a3b9e0d1afd518ad791b").
                            thumbnail(1600, 1200).
                            thumbnail(160, 120).
                            thumbnail(500, 375).
                            issues("JRW-264"),
            // Powershot G10
            ExpectedResults.create("http://www.rawsamples.ch/raws/canon/g10/RAW_CANON_G10.CR2").
                            image(4416, 3312, 3, 8, "596682eeb9690806670b5c6d4ecfaa7b").
                            thumbnail(1600, 1200).
                            thumbnail(160, 120).
                            thumbnail(552, 414).
                            issues("JRW-264"),
            ExpectedResults.create("http://www.rawsamples.ch/raws/canon/g10/RAW_CANON_G10.CR2").
                            param(new RAWImageReadParam(Source.RAW_IMAGE)).
                            image(4480, 3348, 3, 16, "e6c7f849324442fe3950e423e6d8fc68").
                            thumbnail(1600, 1200).
                            thumbnail(160, 120).
                            thumbnail(552, 414).
                            issues("JRW-264")
